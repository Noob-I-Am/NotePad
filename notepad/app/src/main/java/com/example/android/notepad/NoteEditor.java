...
//        mText.setBackgroundColor(Color.parseColor("#0000FF"));
        /*
    ...
    protected void onResume() {
        ...
        if (mCursor != null) {
             ...
             */
             ...
             int colorIndex = mCursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_COLOR);
            System.out.println("颜色index"+colorIndex);
             String color = mCursor.getString(colorIndex);
            if(color!=null)
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem pink=(MenuItem) findViewById(R.id.pink);
        MenuItem white=(MenuItem) findViewById(R.id.white);
        MenuItem light=(MenuItem) findViewById(R.id.light);
...
//        }
        ...
        case R.id.menu_revert:
            ...
            break;
            case R.id.pink:
                mText.setBackgroundColor(Color.parseColor("#FFCCFF"));
                values.put(NotePad.Notes.COLUMN_NAME_COLOR,"#FFCCFF");
            ...
            case R.id.white:
                ...
                values.put(NotePad.Notes.COLUMN_NAME_COLOR,"#FFFFFF");
                getContentResolver().update(
                        mUri,    // The URI for the record to update.
                        values,  // The map of column names and new values to apply to them.
                        null,    // No selection criteria are used, so no where columns are necessary.
                ...
                break;
            case R.id.light:
                mText.setBackgroundColor(Color.parseColor("#66FFFF"));
                values.put(NotePad.Notes.COLUMN_NAME_COLOR,"#66FFFF");
                getContentResolver().update(
                        mUri,    // The URI for the record to update.
                        values,  // The map of column names and new values to apply to them.
                        null,    // No selection criteria are used, so no where columns are necessary.
...
//END_INCLUDE(paste)
    ...
    private final void updateNote(String text, String title) {
        ...
        ContentValues values = new ContentValues();
        SimpleDateFormat dateformat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");//改
        String dateStr = dateformat.format(System.currentTimeMillis());//改
